...
def run_cashflow():
    try:
        ...
        return JSONResponse(content={"message": f"Erreur dans l'analyse cash-flow : {e}"}, media_type="application/json; charset=utf-8")
...
def run_breakout():
    try:
        ...
        return JSONResponse(content={"message": f"Erreur dans l'analyse breakout : {e}"}, media_type="application/json; charset=utf-8")
